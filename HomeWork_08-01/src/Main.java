...
public class Main {
    public static void main(String[] args) throws FullGroupException, StudentNotFoundException, IOException, ClassNotFoundException {
        ...
        Student stud10 = new Student("Tijs", "Vervest", 15, Gender.MALE, 1000010);
...
//        gr.delStudent(1000007);
        ...
        Student[] recruits = gr.getRecruter();
        System.out.println("Next students are going to Army:");
        for (Student student : recruits) {
            System.out.println(student);
        }

        SaveAndLoad.saveGroup(gr);
        Group gr2 = SaveAndLoad.loadGroup("Group.csv");
        System.out.println(gr2);

        System.out.println("=======================================");
        File out = new File("grOutput.csv");
        SaveAndLoad.groupOutput(gr, out);

        System.out.println();
        Group gr3 = SaveAndLoad.groupInput(out);
